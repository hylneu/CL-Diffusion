...
def main(args):
    ...
    img_model, _, preprocess = open_clip.create_model_and_transforms('ViT-H-14', pretrained='/home/hyl/hou/DisenBooth-main/stabilityai/stable-diffusion-2-1-base/open_clip_pytorch_model.bin')
